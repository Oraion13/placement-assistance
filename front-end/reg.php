<?php
   ...
   mysqli_select_db($connect,"placement_assistance") or die("Cant Connect to database"); // Selecting Database from Server
...
{ 
 ...
 if(mysqli_num_rows($check) == 0) 
 {
  if($repassword == $password)
  {
    ...
    if($query = mysqli_query($connect,"INSERT INTO slogin(Name, USN ,PASSWORD,Email,Question,Answer) VALUES ('$Name', '$USN', '$password1','$Email','$Question','$Answer')"))
    {
