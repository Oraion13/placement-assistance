                ...
                <div class="templatemo-content-container">
                        ...
                        <form action="pref1.php" class="templatemo-login-form" method="post" enctype="multipart/form-data">
                            <div class="row form-group">
                                <div class="col-lg-6 col-md-6 form-group">
                                    ...
                                    <input type="text" name="Fname" value=" "  class="form-control" id="inputFirstName" placeholder="Ram">
                                </div>
                                <div class="col-lg-6 col-md-6 form-group">
                                    <label for="inputLastName">Last Name</label>
                                    <input type="text" name="Lname" value = '' class="form-control" id="inputLastName" placeholder="Laxman">
                                </div>
                                <div class="col-lg-6 col-md-6 form-group">
                                    <label for="inputUserName">User Name</label>
                                    <input type="text" name="USERNAME" value ='' class="form-control" id="inputUserName" placeholder="Enter your UserName">
                                </div>

                                <div class="col-lg-6 col-md-6 form-group">
                                    <label for="usn">Register Number</label>
                                    <input type="text" name="RegNo" value = '' class="form-control" id="reg" placeholder="9500XXXXXXXX">
                                </div>

                                <div class="col-lg-6 col-md-6 form-group">
                                    <label for="Phone">Phone:</label>
                                    <input type="text" name="Num" value = '' class="form-control" id="Phone" placeholder="91xxxxxxxx">
                                </div>

                                <div class="col-lg-6 col-md-6 form-group">
                                    <label for="Email">Email</label>
                                    <input type="Email" name="Email" value = '' class="form-control" id="Email" placeholder="abc@example.com">
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 form-group">
                                    ...
                                    <select name="Cursem" value = ''class="form-control">
                    ...
                    <option value="8">8</option>
                                ...
                                <div class="col-lg-6 col-md-6 form-group">
                                    ...
                                    <select name="Branch" value = '' class="form-control">
                    ...
                    <option value="3">ECE</option>
                                ...
                                <div class="col-lg-6 col-md-6 form-group">
                                    ...
                                    <input type="text" name="Percentage" value = '' class="form-control" id="sslc" placeholder="">
                                </div>
                                <div class="col-lg-6 col-md-6 form-group">
                                    <label for="Pu">12th/Diploma Aggregate</label>
                                    <input type="text" name="Puagg" value = '' class="form-control" id="Pu" placeholder="">
                                </div>
                                <div class="col-lg-6 col-md-6 form-group">
                                    <label for="BE">BE Aggregate</label>
                                    <input type="text" name="Beagg" value = '' class="form-control" id="BE" placeholder="">
                                </div>
                                <div class="col-lg-6 col-md-6 form-group">
                                    <label for="BE">PG Aggregate(If you are pursing)</label>
                                    <input type="text" name="Pgagg" value = '' class="form-control" id="BE" placeholder="">
                                </div>
                                <div class="col-lg-6 col-md-6 form-group">
                                    <label class="control-label templatemo-block">Current Backlogs</label>
                                    <select name="Backlogs" value = '' class="form-control">
                    ...
                    <option value="8">8</option>
                                ...
                                <div class="col-lg-6 col-md-6 form-group">
                                    ...
                                    <select name="History" value = '' class="form-control">
                    ...
                    <option value="N">N</option>
                                ...
                                <div class="col-lg-6 col-md-6 form-group">
                                    ...
                                    <select name="Dety" value = '' class="form-control">
                    ...
                    <option value="4">4</option>
                                ...
                                <div class="col-lg-6 col-md-6 form-group">
                                    ...
                                    <input type="text" name="income" value = '' class="form-control" id="reg" placeholder="">
                                </div>
